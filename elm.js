...
var _user$project$Card$numericalRank = function (rank) {
	var _p0 = rank;
	switch (_p0.ctor) {
		case 'Ace':
			return 14;
...
var _user$project$Card$rankDescending = F2(
	function (card1, card2) {
		return A2(
			_elm_lang$core$Basics$compare,
			_user$project$Card$numericalRank(card2.rank),
			_user$project$Card$numericalRank(card1.rank));
	});
var _user$project$Card$Card = F2(
	function (a, b) {
		return {suit: a, rank: b};
	});
var _user$project$Card$Clubs = {ctor: 'Clubs'};
	...
	var cards = _elm_lang$core$List$concat(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$core$List$map,
				addSuit(_user$project$Card$Spades),
				sample.spades),
				A2(
				_elm_lang$core$List$map,
				addSuit(_user$project$Card$Hearts),
				sample.hearts),
				A2(
				_elm_lang$core$List$map,
				addSuit(_user$project$Card$Diamonds),
				sample.diamonds),
				A2(
				_elm_lang$core$List$map,
				addSuit(_user$project$Card$Clubs),
				sample.clubs)
			]));
	var length = _elm_lang$core$List$length(cards);
	...
	var takeCards = F2(
		function (shuffled, n) {
			return _elm_lang$core$Array$toList(
				A3(_elm_lang$core$Array$slice, cardsPerHand * n, cardsPerHand * (n + 1), shuffled));
		});
	return A2(
		_elm_lang$core$Random$map,
		function (shuffled) {
		...
		_elm_community$elm_random_extra$Random_Array$shuffle(_user$project$Card$deck));
}();

var _user$project$Auction$level = function (bid) {
	var _p0 = bid;
	switch (_p0.ctor) {
		case 'Pass':
			return 0;
...
var _user$project$Auction$latestContractualBid = function () {
	var isContractualBid = function (bid) {
		var _p1 = bid;
		if (_p1.ctor === 'Bid') {
			return true;
		} else {
	...
	return function (_p2) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$filter, isContractualBid, _p2));
	};
}();
var _user$project$Auction$canRedouble = function (auction) {
	var _p3 = auction;
	_v2_2:
	do {
		if (_p3.ctor === '::') {
			switch (_p3._0.ctor) {
				case 'Double':
					return true;
				case 'Pass':
					if ((((_p3._1.ctor === '::') && (_p3._1._0.ctor === 'Pass')) && (_p3._1._1.ctor === '::')) && (_p3._1._1._0.ctor === 'Double')) {
						return true;
					} else {
						break _v2_2;
					}
...
var _user$project$Auction$canDouble = function (auction) {
	var _p4 = auction;
	_v3_2:
	do {
		if (_p4.ctor === '::') {
			switch (_p4._0.ctor) {
				case 'Bid':
					return true;
				case 'Pass':
					if ((((_p4._1.ctor === '::') && (_p4._1._0.ctor === 'Pass')) && (_p4._1._1.ctor === '::')) && (_p4._1._1._0.ctor === 'Bid')) {
						return true;
					} else {
						break _v3_2;
					}
...
var _user$project$Auction$isOpen = function (auction) {
	var _p5 = auction;
	if (((((((_p5.ctor === '::') && (_p5._0.ctor === 'Pass')) && (_p5._1.ctor === '::')) && (_p5._1._0.ctor === 'Pass')) && (_p5._1._1.ctor === '::')) && (_p5._1._1._0.ctor === 'Pass')) && (_p5._1._1._1.ctor === '::')) {
		return false;
	} else {
		return true;
	}
};
var _user$project$Auction$Bid = F2(
	function (a, b) {
		return {ctor: 'Bid', _0: a, _1: b};
	});
var _user$project$Auction$contractualBids = function () {
	var bidsAtLevel = function (level) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Auction$Bid(level),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$Auction$legalContractualBids = function (current) {
	var _p6 = current;
	if (_p6.ctor === 'Just') {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			...
			_elm_lang$core$List$tail(
				A2(
					...
					_user$project$Auction$contractualBids)));
	} else {
		return _user$project$Auction$contractualBids;
	}
};
var _user$project$Auction$Redouble = {ctor: 'Redouble'};
var _user$project$Auction$Double = {ctor: 'Double'};
var _user$project$Auction$Pass = {ctor: 'Pass'};
var _user$project$Auction$legalBids = function (auction) {
	var redouble = _user$project$Auction$canRedouble(auction) ? _elm_lang$core$Native_List.fromArray(
		[_user$project$Auction$Redouble]) : _elm_lang$core$Native_List.fromArray(
		[]);
	var $double = _user$project$Auction$canDouble(auction) ? _elm_lang$core$Native_List.fromArray(
		[_user$project$Auction$Double]) : _elm_lang$core$Native_List.fromArray(
		[]);
	return A2(
		_elm_lang$core$List_ops['::'],
		_user$project$Auction$Pass,
		A2(
			_elm_lang$core$Basics_ops['++'],
			$double,
			A2(
				_elm_lang$core$Basics_ops['++'],
				redouble,
				_user$project$Auction$legalContractualBids(
					_user$project$Auction$latestContractualBid(auction)))));
};

var _user$project$Evaluation$quickLosers = F2(
	function (suit, cards) {
		var ranks = A2(
			_elm_lang$core$List$filterMap,
			function (card) {
				return _elm_lang$core$Native_Utils.eq(card.suit, suit) ? _elm_lang$core$Maybe$Just(card.rank) : _elm_lang$core$Maybe$Nothing;
			},
			cards);
		var winners = A2(
			_elm_lang$core$List$indexedMap,
			...
			A2(
				...
				_elm_lang$core$List$length(ranks),
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Card$Ace, _user$project$Card$King, _user$project$Card$Queen, _user$project$Card$Jack])));
		var heldWinners = A2(
			_elm_lang$core$List$filter,
			function (pair) {
				return A2(
			...
			winners);
		var _p0 = _elm_lang$core$List$head(heldWinners);
		if (_p0.ctor === 'Just') {
			return _p0._0._0;
		} else {
...
var _user$project$Evaluation$playingTricks = F2(
	function (trump, cards) {
		var offTrumpTricks = function (ranks) {
			...
			var ranksFromKing = _elm_lang$core$Native_List.fromArray(
				[_user$project$Card$King, _user$project$Card$Queen, _user$project$Card$Jack, _user$project$Card$Ten, _user$project$Card$Nine, _user$project$Card$Eight, _user$project$Card$Seven, _user$project$Card$Six, _user$project$Card$Five, _user$project$Card$Four, _user$project$Card$Three, _user$project$Card$Two]);
			var ranksFromAce = A2(_elm_lang$core$List_ops['::'], _user$project$Card$Ace, ranksFromKing);
			var fromAce = matches(ranksFromAce);
			var fromKing = A2(
				_elm_lang$core$Basics$max,
				matches(ranksFromKing) - 1,
				0);
			return fromAce + fromKing;
		};
		var trumpTricks = function (ranks) {
			var lengthTricks = A2(
				_elm_lang$core$Basics$max,
				_elm_lang$core$List$length(ranks) - 3,
				0);
			var rankTrick = function (rank) {
				return A2(_elm_lang$core$List$member, rank, ranks) ? 1 : 0;
			};
			return ((rankTrick(_user$project$Card$Ace) + rankTrick(_user$project$Card$King)) + rankTrick(_user$project$Card$Queen)) + lengthTricks;
		};
		var suitTricks = function (suit) {
			var ranks = A2(
				_elm_lang$core$List$map,
				function (_) {
					return _.rank;
				...
				A2(
					...
					_user$project$Card$rankDescending,
					A2(
						_elm_lang$core$List$filter,
						function (card) {
							return _elm_lang$core$Native_Utils.eq(card.suit, suit);
						},
						cards)));
			return _elm_lang$core$Native_Utils.eq(
				trump,
	...
	return A2(
		...
		_elm_lang$core$List$maximum(
			A2(
				...
				function (suit) {
					return A2(
						_user$project$Evaluation$playingTricks,
						_elm_lang$core$Maybe$Just(suit),
						cards);
				},
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Card$Spades, _user$project$Card$Hearts, _user$project$Card$Diamonds, _user$project$Card$Clubs]))));
...
var _user$project$Evaluation$semiBalanced = function (dist) {
	...
	_v1_2:
	do {
		if (((((((_p1.ctor === '::') && (_p1._1.ctor === '::')) && (_p1._1._1.ctor === '::')) && (_p1._1._1._0 === 2)) && (_p1._1._1._1.ctor === '::')) && (_p1._1._1._1._0 === 2)) && (_p1._1._1._1._1.ctor === '[]')) {
			switch (_p1._0) {
				case 5:
					if (_p1._1._0 === 4) {
						return true;
...
var _user$project$Evaluation$balanced = function (dist) {
	var _p2 = dist;
	_v2_3:
	do {
		if ((((((_p2.ctor === '::') && (_p2._1.ctor === '::')) && (_p2._1._1.ctor === '::')) && (_p2._1._1._0 === 3)) && (_p2._1._1._1.ctor === '::')) && (_p2._1._1._1._1.ctor === '[]')) {
			switch (_p2._0) {
				case 4:
					switch (_p2._1._0) {
						case 4:
							if (_p2._1._1._1._0 === 2) {
								return true;
							} else {
								break _v2_3;
							}
						case 3:
							if (_p2._1._1._1._0 === 3) {
								return true;
							} else {
								break _v2_3;
							}
				...
				case 5:
					if ((_p2._1._0 === 3) && (_p2._1._1._1._0 === 2)) {
						return true;
					} else {
						break _v2_3;
					}
...
var _user$project$Evaluation$length = F2(
	function (suit, cards) {
		return _elm_lang$core$List$length(
			A2(
				_elm_lang$core$List$filter,
...
var _user$project$Evaluation$distribution = function (cards) {
	return A2(
	...
	function (trump, cards) {
		return _elm_lang$core$List$sum(
			A2(
				_elm_lang$core$List$filter,
				function (pts) {
					return _elm_lang$core$Native_Utils.cmp(pts, 0) > 0;
				},
				A2(
					_elm_lang$core$List$map,
					function (suit) {
						return 3 - A2(_user$project$Evaluation$length, suit, cards);
					},
					A2(
						_elm_lang$core$List$filter,
						function (suit) {
...
var _user$project$Evaluation$highCardPoints = function () {
	...
	return function (_p4) {
		return _elm_lang$core$List$sum(
			A2(_elm_lang$core$List$map, pointsForCard, _p4));
	};
}();
var _user$project$Evaluation$points = F2(
	function (trump, cards) {
		var _p5 = trump;
		if (_p5.ctor === 'Nothing') {
			return _user$project$Evaluation$highCardPoints(cards) + _user$project$Evaluation$lengthPoints(cards);
		} else {
			if (_p5._0.ctor === 'Nothing') {
				return _user$project$Evaluation$highCardPoints(cards);
			} else {
				return _user$project$Evaluation$highCardPoints(cards) + A2(_user$project$Evaluation$shortnessPoints, _p5._0._0, cards);
			}
		}
	});

var _user$project$Seat$lookup = F2(
	function (seat, each) {
		var _p0 = seat;
		switch (_p0.ctor) {
			case 'West':
...
var _user$project$Seat$Each = F4(
	function (a, b, c, d) {
		return {west: a, north: b, east: c, south: d};
	});
var _user$project$Seat$South = {ctor: 'South'};
...
var _user$project$Seat$next = function (seat) {
	...
	switch (_p1.ctor) {
		case 'West':
			return _user$project$Seat$North;
		case 'North':
			return _user$project$Seat$East;
		case 'East':
			return _user$project$Seat$South;
		default:
			return _user$project$Seat$West;
	}
};

var _user$project$Vulnerability$vulnerable = F2(
	function (seat, vuln) {
		var _p0 = seat;
		switch (_p0.ctor) {
			case 'North':
				return vuln.northSouth;
			case 'South':
				return vuln.northSouth;
			case 'East':
				return vuln.eastWest;
			default:
				return vuln.eastWest;
		}
	});
var _user$project$Vulnerability$next = function (vuln) {
	var _p1 = {ctor: '_Tuple2', _0: vuln.northSouth, _1: vuln.eastWest};
	if (_p1._0 === false) {
		if (_p1._1 === false) {
			return {northSouth: false, eastWest: true};
		} else {
			return {northSouth: true, eastWest: false};
		}
	} else {
		if (_p1._1 === false) {
			return {northSouth: true, eastWest: true};
		} else {
			return {northSouth: false, eastWest: false};
		}
	}
};
var _user$project$Vulnerability$initial = {northSouth: false, eastWest: false};
var _user$project$Vulnerability$Vulnerability = F2(
	function (a, b) {
		return {northSouth: a, eastWest: b};
	});
var _user$project$Vulnerability$Favorable = {ctor: 'Favorable'};
var _user$project$Vulnerability$Equal = {ctor: 'Equal'};
var _user$project$Vulnerability$Unfavorable = {ctor: 'Unfavorable'};
var _user$project$Vulnerability$favorability = F2(
	function (seat, vuln) {
		var opponent = _user$project$Seat$next(seat);
		var _p2 = {
			ctor: '_Tuple2',
			_0: A2(_user$project$Vulnerability$vulnerable, seat, vuln),
			_1: A2(_user$project$Vulnerability$vulnerable, opponent, vuln)
		};
		if (_p2._0 === false) {
			if (_p2._1 === false) {
				return _user$project$Vulnerability$Equal;
			} else {
				return _user$project$Vulnerability$Favorable;
			}
		} else {
			if (_p2._1 === false) {
				return _user$project$Vulnerability$Unfavorable;
			} else {
				return _user$project$Vulnerability$Equal;
			}
		}
	});
var _user$project$Vulnerability$opposing = function (favorability) {
	var _p3 = favorability;
	switch (_p3.ctor) {
		case 'Equal':
			return _user$project$Vulnerability$Equal;
		case 'Favorable':
...
var _user$project$Bidding$eval = F2(
	function (metric, hand) {
		var _p0 = metric;
		switch (_p0.ctor) {
			case 'Constant':
				return _p0._0;
			case 'HighCardPoints':
				return _user$project$Evaluation$highCardPoints(hand);
			case 'Points':
			...
			default:
				return A2(_user$project$Evaluation$quickLosers, _p0._0, hand);
		}
	});
var _user$project$Bidding$satisfiedBy = F2(
	function (hand, bid) {
		var satisfies = function (meaning) {
			var _p1 = meaning;
			switch (_p1.ctor) {
				case 'OutOfSystem':
					return true;
				case 'Equal':
					return _elm_lang$core$Native_Utils.eq(
						...
						A2(_user$project$Bidding$eval, _p1._1, hand));
				case 'InRange':
					var value = A2(_user$project$Bidding$eval, _p1._0, hand);
					return (_elm_lang$core$Native_Utils.cmp(_p1._1, value) < 1) && (_elm_lang$core$Native_Utils.cmp(value, _p1._2) < 1);
				case 'Minimum':
					return _elm_lang$core$Native_Utils.cmp(
						A2(_user$project$Bidding$eval, _p1._1, hand),
						A2(_user$project$Bidding$eval, _p1._0, hand)) < 1;
				case 'Maximum':
					return _elm_lang$core$Native_Utils.cmp(
						A2(_user$project$Bidding$eval, _p1._0, hand),
						A2(_user$project$Bidding$eval, _p1._1, hand)) < 1;
				case 'GreaterThan':
					return _elm_lang$core$Native_Utils.cmp(
						A2(_user$project$Bidding$eval, _p1._1, hand),
						A2(_user$project$Bidding$eval, _p1._0, hand)) < 0;
				case 'LessThan':
					return _elm_lang$core$Native_Utils.cmp(
						A2(_user$project$Bidding$eval, _p1._0, hand),
						A2(_user$project$Bidding$eval, _p1._1, hand)) < 0;
				case 'Balanced':
					return _user$project$Evaluation$balanced(
						_user$project$Evaluation$distribution(hand));
				case 'SemiBalanced':
					return _user$project$Evaluation$semiBalanced(
						_user$project$Evaluation$distribution(hand));
				case 'Or':
					return A2(_elm_lang$core$List$any, satisfies, _p1._0);
				case 'And':
					return A2(_elm_lang$core$List$all, satisfies, _p1._0);
				default:
					return _elm_lang$core$Basics$not(
						satisfies(_p1._0));
			}
		};
		return satisfies(bid.meaning);
	});
var _user$project$Bidding$viableChoices = F4(
	function (system, favorability, history, hand) {
		return A2(
			_elm_lang$core$List$filter,
			_user$project$Bidding$satisfiedBy(hand),
			A2(system.suggestions, favorability, history));
	});
var _user$project$Bidding$lookup = function (bid) {
	return function (_p2) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (choice) {
					return _elm_lang$core$Native_Utils.eq(choice.bid, bid);
				},
				_p2));
	};
};
var _user$project$Bidding$System = F2(
	function (a, b) {
		return {name: a, suggestions: b};
	});
var _user$project$Bidding$AnnotatedBid = F4(
	function (a, b, c, d) {
		return {bid: a, meaning: b, description: c, convention: d};
	});
var _user$project$Bidding$Stayman = {ctor: 'Stayman'};
var _user$project$Bidding$JacobyTransfer = {ctor: 'JacobyTransfer'};
var _user$project$Bidding$Gerber = {ctor: 'Gerber'};
var _user$project$Bidding$Deny = function (a) {
	return {ctor: 'Deny', _0: a};
};
var _user$project$Bidding$And = function (a) {
	return {ctor: 'And', _0: a};
};
var _user$project$Bidding$Or = function (a) {
	return {ctor: 'Or', _0: a};
};
var _user$project$Bidding$SemiBalanced = {ctor: 'SemiBalanced'};
var _user$project$Bidding$Balanced = {ctor: 'Balanced'};
var _user$project$Bidding$LessThan = F2(
	function (a, b) {
		return {ctor: 'LessThan', _0: a, _1: b};
	});
var _user$project$Bidding$GreaterThan = F2(
	function (a, b) {
		return {ctor: 'GreaterThan', _0: a, _1: b};
	});
var _user$project$Bidding$Maximum = F2(
	function (a, b) {
		return {ctor: 'Maximum', _0: a, _1: b};
	});
var _user$project$Bidding$Minimum = F2(
	function (a, b) {
		return {ctor: 'Minimum', _0: a, _1: b};
	});
var _user$project$Bidding$Equal = F2(
	function (a, b) {
		return {ctor: 'Equal', _0: a, _1: b};
	});
var _user$project$Bidding$InRange = F3(
	function (a, b, c) {
...
var _user$project$Bidding$annotate = F4(
	function (system, favorability, history, bid) {
		var _p3 = A2(
			_user$project$Bidding$lookup,
			bid,
			A2(system.suggestions, favorability, history));
		if (_p3.ctor === 'Just') {
			return _p3._0;
		} else {
			return _user$project$Bidding$outOfSystem(bid);
		}
	});
var _user$project$Bidding$choose = F4(
	function (system, favorability, history, hand) {
		var fallback = _user$project$Bidding$outOfSystem(_user$project$Auction$Pass);
		return A2(
			_elm_community$elm_random_extra$Random_Extra$selectWithDefault,
			fallback,
			A4(_user$project$Bidding$viableChoices, system, favorability, history, hand));
	});
var _user$project$Bidding$QuickLosers = function (a) {
...
var _user$project$Bidding$Points = function (a) {
	return {ctor: 'Points', _0: a};
};
var _user$project$Bidding$HighCardPoints = {ctor: 'HighCardPoints'};
var _user$project$Bidding$Constant = function (a) {
	return {ctor: 'Constant', _0: a};
};
var _user$project$Bidding$Defender = {ctor: 'Defender'};
var _user$project$Bidding$Responder = {ctor: 'Responder'};
var _user$project$Bidding$Opener = {ctor: 'Opener'};
var _user$project$Bidding$Openable = {ctor: 'Openable'};
var _user$project$Bidding$role$ = function (history) {
	var bidsFromOpening = _elm_lang$core$List$length(
		A2(
			_elm_community$elm_list_extra$List_Extra$dropWhile,
			function (bid) {
				return _elm_lang$core$Native_Utils.eq(bid, _user$project$Auction$Pass);
			},
			_elm_lang$core$List$reverse(history)));
	var _p4 = A2(_elm_lang$core$Basics_ops['%'], bidsFromOpening, 4);
	switch (_p4) {
		case 0:
			return _elm_lang$core$Native_Utils.eq(bidsFromOpening, 0) ? _user$project$Bidding$Openable : _user$project$Bidding$Opener;
		case 1:
			return _user$project$Bidding$Defender;
		case 2:
			return _user$project$Bidding$Responder;
		case 3:
			return _user$project$Bidding$Defender;
		default:
			return _elm_lang$core$Native_Utils.crashCase(
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(bidsFromOpening),
						' somehow!')));
	}
};
var _user$project$Bidding$role = function (_p6) {
	return _user$project$Bidding$role$(
		A2(
			_elm_lang$core$List$map,
			function (_) {
				return _.bid;
...
var _user$project$Bidding_Stayman$response = F2(
	function (_p0, history) {
		...
		var hearts = function (level) {
			return {
				bid: A2(
					...
					level,
					_elm_lang$core$Maybe$Just(_user$project$Card$Hearts)),
				meaning: show(_user$project$Card$Hearts),
				description: _elm_lang$core$Maybe$Just('show four or more hearts'),
				convention: _elm_lang$core$Maybe$Just(_user$project$Bidding$Stayman)
			};
		};
		var deny = function (suit) {
			return A2(
		...
		var negative = function (level) {
			return {
				...
				meaning: _user$project$Bidding$And(
					_elm_lang$core$Native_List.fromArray(
						[
							deny(_user$project$Card$Hearts),
							deny(_user$project$Card$Spades)
						])),
				description: _elm_lang$core$Maybe$Just('deny four-card majors'),
				convention: _elm_lang$core$Maybe$Just(_user$project$Bidding$Stayman)
			};
		};
			...
			return {
				...
				meaning: _user$project$Bidding$And(
					_elm_lang$core$Native_List.fromArray(
						[
							deny(_user$project$Card$Hearts),
							show(_user$project$Card$Spades)
						])),
				description: _elm_lang$core$Maybe$Just('deny four hearts, show four or more spades'),
				convention: _elm_lang$core$Maybe$Just(_user$project$Bidding$Stayman)
			};
		};
		var responses = function (level) {
			return _elm_lang$core$Native_List.fromArray(
				[
					negative(level),
					hearts(level),
		...
		if ((((((_p1.ctor === '::') && (_p1._0.ctor === 'Pass')) && (_p1._1.ctor === '::')) && (_p1._1._0.ctor === 'Bid')) && (_p1._1._0._1.ctor === 'Just')) && (_p1._1._0._1._0.ctor === 'Clubs')) {
			return _elm_lang$core$Maybe$Just(
				responses(_p1._1._0._0));
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _user$project$Bidding_Stayman$bid = F2(
	function (level, extraConditions) {
		var baseConditions = _elm_lang$core$Native_List.fromArray(
			[
				_user$project$Bidding$Or(
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_user$project$Bidding$Minimum,
				...
				_user$project$Bidding_Stayman$notFourThreeThreeThree
			]);
		var conditions = A2(
			_elm_lang$core$Basics_ops['++'],
			baseConditions,
		...
		return {
			...
			description: _elm_lang$core$Maybe$Just('ask for four-card major'),
			convention: _elm_lang$core$Maybe$Just(_user$project$Bidding$Stayman)
		};
	});

var _user$project$Bidding_ConventionResponse$conventionResponse = F2(
...
var _user$project$Bidding_ConventionResponse$withConventionResponse = F3(
	function (suggestions, favorability, history) {
		var _p2 = A2(_user$project$Bidding_ConventionResponse$conventionResponse, favorability, history);
		if (_p2.ctor === 'Just') {
			return _p2._0;
		} else {
	...
	var downgrade = F2(
		function (denials, bid) {
			return _elm_lang$core$Native_Utils.update(
				...
				{
					meaning: _user$project$Bidding$And(
						A2(_elm_lang$core$List_ops['::'], bid.meaning, denials))
				});
		});
	var prioritized$ = F2(
		function (denials, prefs) {
			var _p0 = prefs;
			if (_p0.ctor === '[]') {
				return _elm_lang$core$Native_List.fromArray(
					[]);
				...
				var denials$ = A2(
					...
					A2(
						_elm_lang$core$List$map,
						function (_p1) {
							return _user$project$Bidding$Deny(
								function (_) {
									return _.meaning;
								}(_p1));
						},
...
var _user$project$Bidding_StandardAmerican$responsesToThreeNoTrump = function () {
	...
	var pass = {
		bid: _user$project$Auction$Pass,
		description: _elm_lang$core$Maybe$Nothing,
		convention: _elm_lang$core$Maybe$Nothing,
		meaning: _user$project$Bidding$Or(
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Bidding$And(
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_user$project$Bidding$LessThan,
					...
					_user$project$Bidding_StandardAmerican$fourThreeThreeThree
				]))
	};
	var otherMajor = function (major) {
		...
		switch (_p3.ctor) {
			case 'Spades':
				return _user$project$Card$Hearts;
			case 'Hearts':
				return _user$project$Card$Spades;
			default:
				return _elm_lang$core$Native_Utils.crashCase(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(major),
...
var _user$project$Bidding_StandardAmerican$responsesToTwoNoTrump = function () {
	...
	var inviteSlam = {
		...
		description: _elm_lang$core$Maybe$Just('quantitative raise'),
		convention: _elm_lang$core$Maybe$Nothing,
		meaning: A2(
			_user$project$Bidding$Minimum,
		...
		meaning: _user$project$Bidding$And(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Bidding$LessThan,
					_user$project$Bidding$HighCardPoints,
					_user$project$Bidding$Constant(gamePoints)),
					A2(
					_user$project$Bidding$LessThan,
					_user$project$Bidding$Length(_user$project$Card$Spades),
					_user$project$Bidding$Constant(5)),
	...
	var stayman = A2(
		_user$project$Bidding_Stayman$bid,
		3,
		_elm_lang$core$Maybe$Just(
			A3(
				_user$project$Bidding$InRange,
				_user$project$Bidding$Points(_elm_lang$core$Maybe$Nothing),
				gamePoints,
				inviteSlamPoints - 1)));
	var game = {
		bid: A2(_user$project$Auction$Bid, 3, _elm_lang$core$Maybe$Nothing),
		description: _elm_lang$core$Maybe$Just('raise to game'),
		convention: _elm_lang$core$Maybe$Nothing,
		meaning: _user$project$Bidding$And(
			_elm_lang$core$Native_List.fromArray(
				[
					A3(_user$project$Bidding$InRange, _user$project$Bidding$HighCardPoints, gamePoints, inviteSlamPoints - 1),
					_user$project$Bidding$Or(
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Bidding$And(
...
var _user$project$Bidding_StandardAmerican$responsesToOneNoTrump = function () {
	var atLeastOneVoid = function () {
		var voidIn = function (suit) {
			return A2(
	...
	var minorSlam = function (suit) {
		return {
			bid: A2(
				...
				6,
				_elm_lang$core$Maybe$Just(suit)),
			description: _elm_lang$core$Maybe$Just('Slam'),
			convention: _elm_lang$core$Maybe$Nothing,
			meaning: _user$project$Bidding$And(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Bidding$Points(
							_elm_lang$core$Maybe$Just(
								_elm_lang$core$Maybe$Just(suit))),
						_user$project$Bidding$Constant(20)),
						A2(
						_user$project$Bidding$Minimum,
						_user$project$Bidding$Length(suit),
						_user$project$Bidding$Constant(6)),
						atLeastOneVoid
					]))
		};
	};
	var bidGame = {
		bid: A2(_user$project$Auction$Bid, 3, _elm_lang$core$Maybe$Nothing),
		description: _elm_lang$core$Maybe$Just('Game'),
		convention: _elm_lang$core$Maybe$Nothing,
		meaning: A3(_user$project$Bidding$InRange, _user$project$Bidding$HighCardPoints, 10, 15)
	};
	var inviteGameWithLongMinor = function (suit) {
		return {
			bid: A2(
				...
				3,
				_elm_lang$core$Maybe$Just(suit)),
			description: _elm_lang$core$Maybe$Just('Game invite'),
			convention: _elm_lang$core$Maybe$Nothing,
			meaning: _user$project$Bidding$And(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Bidding$Length(suit),
						_user$project$Bidding$Constant(6)),
						A3(_user$project$Bidding$InRange, _user$project$Bidding$HighCardPoints, 7, 9)
					]))
		};
	};
	var stayman = A2(
		...
		_elm_lang$core$Maybe$Just(
			A2(
				_user$project$Bidding$Minimum,
				_user$project$Bidding$Points(_elm_lang$core$Maybe$Nothing),
				_user$project$Bidding$Constant(8))));
	var minorTransfer = {
		bid: A2(
			_user$project$Auction$Bid,
			2,
			_elm_lang$core$Maybe$Just(_user$project$Card$Spades)),
		description: _elm_lang$core$Maybe$Just('Minor Transfer'),
		convention: _elm_lang$core$Maybe$Nothing,
		meaning: _user$project$Bidding$And(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_user$project$Bidding$Minimum,
							_user$project$Bidding$Length(_user$project$Card$Clubs),
							_user$project$Bidding$Constant(6)),
							A2(
							_user$project$Bidding$Minimum,
							_user$project$Bidding$Length(_user$project$Card$Diamonds),
							_user$project$Bidding$Constant(6))
						])),
					A2(
					_user$project$Bidding$LessThan,
					_user$project$Bidding$HighCardPoints,
					_user$project$Bidding$Constant(7))
				]))
	};
	var pass = {
		bid: _user$project$Auction$Pass,
	...
	var noFourCardMajor = _user$project$Bidding$And(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_user$project$Bidding$Maximum,
	...
	var inviteGame = {
		bid: A2(_user$project$Auction$Bid, 2, _elm_lang$core$Maybe$Nothing),
		description: _elm_lang$core$Maybe$Just('Game invite'),
		convention: _elm_lang$core$Maybe$Nothing,
		meaning: _user$project$Bidding$And(
			_elm_lang$core$Native_List.fromArray(
				[
					A3(_user$project$Bidding$InRange, _user$project$Bidding$HighCardPoints, 8, 9),
					_user$project$Bidding$Or(
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Bidding$Balanced, _user$project$Bidding$SemiBalanced])),
					_user$project$Bidding$Or(
					_elm_lang$core$Native_List.fromArray(
						[noFourCardMajor, _user$project$Bidding_StandardAmerican$fourThreeThreeThree]))
				]))
	};
	...
	var inviteSlam = function (suit) {
		return {
			bid: A2(
				...
				3,
				_elm_lang$core$Maybe$Just(suit)),
			description: _elm_lang$core$Maybe$Just('Slam invite'),
			convention: _elm_lang$core$Maybe$Nothing,
			meaning: _user$project$Bidding$And(
				_elm_lang$core$Native_List.fromArray(
					[
	...
	var priority2 = _elm_lang$core$Native_List.fromArray(
		[
			...
			inviteGameWithLongMinor(_user$project$Card$Diamonds),
			inviteSlam(_user$project$Card$Hearts),
			inviteSlam(_user$project$Card$Spades)
		]);
	var inviteSlamNoTrump = {
		bid: A2(_user$project$Auction$Bid, 4, _elm_lang$core$Maybe$Nothing),
		description: _elm_lang$core$Maybe$Just('Quantitative raise'),
		convention: _elm_lang$core$Maybe$Nothing,
		meaning: _user$project$Bidding$And(
			_elm_lang$core$Native_List.fromArray(
				[
					A3(_user$project$Bidding$InRange, _user$project$Bidding$HighCardPoints, inviteSlamPoints, inviteSlamPoints + 1),
					_user$project$Bidding$Or(
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Bidding$Balanced, _user$project$Bidding$SemiBalanced]))
				]))
	...
	var priority1 = _elm_lang$core$Native_List.fromArray(
		[
			inviteSlamNoTrump,
			gerber,
			minorSlam(_user$project$Card$Clubs),
			minorSlam(_user$project$Card$Diamonds)
		]);
	return _user$project$Bidding_StandardAmerican$prioritized(
		_elm_lang$core$Native_List.fromArray(
			[priority1, priority2, priority3]));
}();
var _user$project$Bidding_StandardAmerican$responseBids = function (history) {
	var firstResponse = function () {
		...
		if (((_p5.ctor === '::') && (_p5._0.ctor === 'Pass')) && (_p5._1.ctor === '::')) {
			return A2(
				...
				_p5._1._1) ? _elm_lang$core$Maybe$Just(_p5._1._0) : _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	}();
	...
	do {
		if (((_p6.ctor === 'Just') && (_p6._0.ctor === 'Bid')) && (_p6._0._1.ctor === 'Nothing')) {
			switch (_p6._0._0) {
				case 1:
					return _user$project$Bidding_StandardAmerican$responsesToOneNoTrump;
				case 2:
					return _user$project$Bidding_StandardAmerican$responsesToTwoNoTrump;
				case 3:
					return _user$project$Bidding_StandardAmerican$responsesToThreeNoTrump;
				default:
					break _v3_3;
			}
		} else {
...
var _user$project$Bidding_StandardAmerican$openingBids = F2(
	function (favorability, history) {
		var fourthSeatThree = function (suit) {
			return {
				bid: A2(
					...
					3,
					_elm_lang$core$Maybe$Just(suit)),
				description: _elm_lang$core$Maybe$Just('Non-preempt'),
				convention: _elm_lang$core$Maybe$Nothing,
				meaning: _user$project$Bidding$And(
					_elm_lang$core$Native_List.fromArray(
						[
							A3(_user$project$Bidding$InRange, _user$project$Bidding$HighCardPoints, 10, 12),
							A2(
							_user$project$Bidding$Minimum,
							_user$project$Bidding$Length(suit),
							_user$project$Bidding$Constant(7))
		...
		var preemptTricks = function (level) {
			...
			return _user$project$Bidding$Constant((6 + level) - margin);
		};
		var preempt = F3(
			function (level, suit, trickCondition) {
				return {
					bid: A2(
						_user$project$Auction$Bid,
						level,
						_elm_lang$core$Maybe$Just(suit)),
					description: _elm_lang$core$Maybe$Just('Preempt'),
					convention: _elm_lang$core$Maybe$Nothing,
					meaning: _user$project$Bidding$And(
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$Bidding$Maximum,
								_user$project$Bidding$HighCardPoints,
								_user$project$Bidding$Constant(10)),
								A2(
								_user$project$Bidding$Minimum,
								_user$project$Bidding$Length(suit),
								_user$project$Bidding$Constant(7)),
								A2(
								trickCondition,
								_user$project$Bidding$PlayingTricks,
								preemptTricks(level))
							]))
				};
			});
		var highestPreempt = F2(
			function (level, suit) {
				return A3(preempt, level, suit, _user$project$Bidding$Minimum);
			});
		var moderatePreempt = F2(
			function (level, suit) {
				return A3(preempt, level, suit, _user$project$Bidding$Equal);
			});
		var strongPoints = 22;
		var oneLevelMaximumPoints = A2(
			_user$project$Bidding$LessThan,
			_user$project$Bidding$HighCardPoints,
			_user$project$Bidding$Constant(strongPoints));
		var oneLevelPoints = 13;
		var oneLevelMinimumPoints = A2(
			_user$project$Bidding$Minimum,
			_user$project$Bidding$Points(_elm_lang$core$Maybe$Nothing),
			_user$project$Bidding$Constant(oneLevelPoints));
		var weakTwo = function (suit) {
			return {
				bid: A2(
					...
					2,
					_elm_lang$core$Maybe$Just(suit)),
				description: _elm_lang$core$Maybe$Just('Weak'),
				convention: _elm_lang$core$Maybe$Nothing,
				meaning: _user$project$Bidding$And(
					_elm_lang$core$Native_List.fromArray(
						[
							A3(_user$project$Bidding$InRange, _user$project$Bidding$HighCardPoints, 5, 10),
							A2(
							_user$project$Bidding$LessThan,
							_user$project$Bidding$Points(_elm_lang$core$Maybe$Nothing),
							_user$project$Bidding$Constant(oneLevelPoints)),
				...
				return _user$project$Bidding$Or(
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_user$project$Bidding$LessThan,
							_user$project$Bidding$Length(major),
							_user$project$Bidding$Constant(majorLength)),
							A2(
							_user$project$Bidding$GreaterThan,
							_user$project$Bidding$Length(minor),
							_user$project$Bidding$Length(major))
						]));
			});
		var oneDiamonds = {
			bid: A2(
				...
				1,
				_elm_lang$core$Maybe$Just(_user$project$Card$Diamonds)),
			description: _elm_lang$core$Maybe$Just('No five-card major'),
			convention: _elm_lang$core$Maybe$Nothing,
			meaning: _user$project$Bidding$And(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Bidding$Minimum,
						_user$project$Bidding$Length(_user$project$Card$Diamonds),
						_user$project$Bidding$Constant(minorLength)),
						A2(openWithMinor, _user$project$Card$Diamonds, _user$project$Card$Spades),
						A2(openWithMinor, _user$project$Card$Diamonds, _user$project$Card$Hearts),
						A2(
						_user$project$Bidding$Minimum,
						_user$project$Bidding$Length(_user$project$Card$Diamonds),
						_user$project$Bidding$Length(_user$project$Card$Clubs)),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$Bidding$Minimum,
								_user$project$Bidding$Length(_user$project$Card$Diamonds),
								_user$project$Bidding$Constant(minorLength + 1))
							]))
					]))
		};
		var oneClubs = {
			...
			meaning: _user$project$Bidding$And(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Bidding$Length(_user$project$Card$Clubs),
						_user$project$Bidding$Constant(minorLength)),
						A2(openWithMinor, _user$project$Card$Clubs, _user$project$Card$Spades),
						A2(openWithMinor, _user$project$Card$Clubs, _user$project$Card$Hearts),
						A2(
						_user$project$Bidding$Minimum,
						_user$project$Bidding$Length(_user$project$Card$Clubs),
						_user$project$Bidding$Length(_user$project$Card$Diamonds)),
		...
		var oneSpades = {
			bid: A2(
				...
				1,
				_elm_lang$core$Maybe$Just(_user$project$Card$Spades)),
			description: _elm_lang$core$Maybe$Just('Five-card major'),
			convention: _elm_lang$core$Maybe$Nothing,
			meaning: _user$project$Bidding$And(
				_elm_lang$core$Native_List.fromArray(
					[
		...
		var twoClubs = function () {
			var fiveCardMajor = _user$project$Bidding$Or(
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_user$project$Bidding$Minimum,
			...
			var oneShyOfMinorGame = A2(
				_user$project$Bidding$Minimum,
				_user$project$Bidding$PlayingTricks,
				_user$project$Bidding$Constant(10));
			var oneShyOfMajorGame = _user$project$Bidding$And(
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_user$project$Bidding$Minimum,
						_user$project$Bidding$PlayingTricks,
						_user$project$Bidding$Constant(9)),
						fiveCardMajor
					]));
			var weakerMeaning = _user$project$Bidding$And(
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_user$project$Bidding$Minimum,
						...
						_user$project$Bidding$Or(
						_elm_lang$core$Native_List.fromArray(
							[oneShyOfMajorGame, oneShyOfMinorGame]))
					]));
			var standardMeaning = A2(
				_user$project$Bidding$Minimum,
				_user$project$Bidding$HighCardPoints,
				_user$project$Bidding$Constant(strongPoints));
			return {
				bid: A2(
					...
					2,
					_elm_lang$core$Maybe$Just(_user$project$Card$Clubs)),
				description: _elm_lang$core$Maybe$Just('Strong 2♣'),
				convention: _elm_lang$core$Maybe$Nothing,
				meaning: _user$project$Bidding$Or(
					_elm_lang$core$Native_List.fromArray(
						[standardMeaning, weakerMeaning]))
			};
		}();
		var noTrump = F3(
			function (level, lo, hi) {
				return {
					...
					description: _elm_lang$core$Maybe$Just('Balanced opening'),
					convention: _elm_lang$core$Maybe$Nothing,
					meaning: _user$project$Bidding$And(
						_elm_lang$core$Native_List.fromArray(
							[
								A3(_user$project$Bidding$InRange, _user$project$Bidding$HighCardPoints, lo, hi),
								_user$project$Bidding$Balanced
							]))
				};
			});
		...
		var threeInsteadOfOne = function (suit) {
			var betterBid = fourthSeat ? fourthSeatThree(suit) : A2(highestPreempt, 3, suit);
			return betterBid.meaning;
		};
		var preempts = fourthSeat ? _elm_lang$core$Native_List.fromArray(
			[
				fourthSeatThree(_user$project$Card$Clubs),
				fourthSeatThree(_user$project$Card$Diamonds),
				fourthSeatThree(_user$project$Card$Hearts),
				fourthSeatThree(_user$project$Card$Spades)
			]) : _elm_lang$core$Native_List.fromArray(
			[
				A2(moderatePreempt, 3, _user$project$Card$Clubs),
				A2(moderatePreempt, 3, _user$project$Card$Diamonds),
				A2(moderatePreempt, 3, _user$project$Card$Hearts),
				A2(moderatePreempt, 3, _user$project$Card$Spades),
				A2(moderatePreempt, 4, _user$project$Card$Clubs),
				A2(moderatePreempt, 4, _user$project$Card$Diamonds),
				A2(highestPreempt, 4, _user$project$Card$Hearts),
				A2(highestPreempt, 4, _user$project$Card$Spades),
				A2(highestPreempt, 5, _user$project$Card$Clubs),
				A2(highestPreempt, 5, _user$project$Card$Diamonds)
			]);
		return _user$project$Bidding_StandardAmerican$prioritized(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					[
						twoClubs,
						weakTwo(_user$project$Card$Diamonds),
						weakTwo(_user$project$Card$Hearts),
						weakTwo(_user$project$Card$Spades)
					]),
					_elm_lang$core$Native_List.fromArray(
...
var _user$project$Bidding_StandardAmerican$suggest = F2(
	function (favorability, history) {
		var _p9 = _user$project$Bidding$role(history);
		switch (_p9.ctor) {
			case 'Openable':
				return A2(_user$project$Bidding_StandardAmerican$openingBids, favorability, history);
			case 'Responder':
				return _user$project$Bidding_StandardAmerican$responseBids(history);
			default:
				return _elm_lang$core$Native_List.fromArray(
					[]);
		}
	});
var _user$project$Bidding_StandardAmerican$system = {
	name: 'Standard American Yellow Card',
	suggestions: _user$project$Bidding_ConventionResponse$withConventionResponse(_user$project$Bidding_StandardAmerican$suggest)
};

var _user$project$Game$currentBidder = F2(
	function (dealer, auction) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (x, y) {
			...
			A2(
				...
				_elm_lang$core$List$length(auction),
				_user$project$Seat$next));
	});
var _user$project$Game$deal = F3(
	function (dealer, vulnerability, dealt) {
		var hands = function () {
			var _p0 = dealt;
			if (((((_p0.ctor === '::') && (_p0._1.ctor === '::')) && (_p0._1._1.ctor === '::')) && (_p0._1._1._1.ctor === '::')) && (_p0._1._1._1._1.ctor === '[]')) {
				return {west: _p0._0, north: _p0._1._0, east: _p0._1._1._0, south: _p0._1._1._1._0};
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'Game',
					{
					...
					_p0)('Card.deal didn\'t return exactly four hands!');
			}
		}();
		var state = {
			system: _user$project$Bidding_StandardAmerican$system,
			hands: hands,
			dealer: dealer,
			vulnerability: vulnerability,
			auction: _elm_lang$core$Native_List.fromArray(
				[]),
			explained: _elm_lang$core$Maybe$Nothing
		};
		return state;
	});
var _user$project$Game$GameState = F6(
	function (a, b, c, d, e, f) {
		return {system: a, hands: b, dealer: c, vulnerability: d, auction: e, explained: f};
	});
var _user$project$Game$RageQuit = {ctor: 'RageQuit'};
var _user$project$Game$Explain = function (a) {
	return {ctor: 'Explain', _0: a};
};
var _user$project$Game$BidFromHuman = function (a) {
	return {ctor: 'BidFromHuman', _0: a};
};
var _user$project$Game$BidFromBot = function (a) {
	return {ctor: 'BidFromBot', _0: a};
};
var _user$project$Game$bidForBot = function (state) {
	var nextBidder = A2(_user$project$Game$currentBidder, state.dealer, state.auction);
	if ((!_elm_lang$core$Native_Utils.eq(nextBidder, _user$project$Seat$South)) && _user$project$Auction$isOpen(
		A2(
			_elm_lang$core$List$map,
			function (_) {
				return _.bid;
			...
			state.auction))) {
		var favorability = A2(_user$project$Vulnerability$favorability, nextBidder, state.vulnerability);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Maybe$Just(state),
			_1: A2(
				_elm_lang$core$Random$generate,
				_user$project$Game$BidFromBot,
				A4(
					_user$project$Bidding$choose,
					state.system,
					favorability,
					state.auction,
					A2(_user$project$Seat$lookup, nextBidder, state.hands)))
		};
	} else {
		return {
			ctor: '_Tuple2',
...
var _user$project$Game$NewDeal = function (a) {
	return {ctor: 'NewDeal', _0: a};
};
var _user$project$Game$init = {
	ctor: '_Tuple2',
	_0: _elm_lang$core$Maybe$Nothing,
	_1: A2(_elm_lang$core$Random$generate, _user$project$Game$NewDeal, _user$project$Card$deal)
};
		...
		do {
			if (_p2._1.ctor === 'Just') {
				switch (_p2._0.ctor) {
					case 'NewDeal':
						var _p3 = _p2._1._0;
						return _user$project$Game$bidForBot(
							A3(
								_user$project$Game$deal,
								_user$project$Seat$next(_p3.dealer),
								_user$project$Vulnerability$next(_p3.vulnerability),
								_p2._0._0));
					case 'BidFromBot':
						var _p4 = _p2._1._0;
						var newState = _elm_lang$core$Native_Utils.update(
							_p4,
							{
								auction: A2(_elm_lang$core$List_ops['::'], _p2._0._0, _p4.auction)
							});
						return _user$project$Game$bidForBot(newState);
					case 'BidFromHuman':
						var _p5 = _p2._1._0;
						var favorability = A2(
							_user$project$Vulnerability$favorability,
							A2(_user$project$Game$currentBidder, _p5.dealer, _p5.auction),
							_p5.vulnerability);
						var annotated = A4(_user$project$Bidding$annotate, _p5.system, favorability, _p5.auction, _p2._0._0);
						var newState = _elm_lang$core$Native_Utils.update(
							_p5,
							{
								auction: A2(_elm_lang$core$List_ops['::'], annotated, _p5.auction)
							});
						return _user$project$Game$bidForBot(newState);
					case 'Explain':
						var newState = _elm_lang$core$Native_Utils.update(
						...
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Maybe$Just(newState),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					default:
						break _v1_5;
				...
				switch (_p2._0.ctor) {
					case 'NewDeal':
						return _user$project$Game$bidForBot(
							A3(_user$project$Game$deal, _user$project$Seat$South, _user$project$Vulnerability$initial, _p2._0._0));
					case 'RageQuit':
						break _v1_5;
					default:
...
var _user$project$View$collapseRedundancies = function (meaning) {
	var grandchildren = function (meaning) {
		var _p0 = meaning;
		switch (_p0.ctor) {
			case 'And':
				return _p0._0;
	...
	switch (_p4.ctor) {
		case 'And':
			var children$ = A2(_elm_lang$core$List$map, _user$project$View$collapseRedundancies, _p4._0);
			return A2(_elm_lang$core$List$all, isAnd, children$) ? _user$project$Bidding$And(
				A2(_elm_lang$core$List$concatMap, grandchildren, children$)) : _user$project$Bidding$And(children$);
		case 'Or':
			var children$ = A2(_elm_lang$core$List$map, _user$project$View$collapseRedundancies, _p4._0);
			return A2(_elm_lang$core$List$all, isOr, children$) ? _user$project$Bidding$Or(
				A2(_elm_lang$core$List$concatMap, grandchildren, children$)) : _user$project$Bidding$Or(children$);
		default:
			return meaning;
	}
};
var _user$project$View$collapseDegenerates = function (meaning) {
	collapseDegenerates:
	while (true) {
		var _p5 = meaning;
		switch (_p5.ctor) {
			case 'And':
				if ((_p5._0.ctor === '::') && (_p5._0._1.ctor === '[]')) {
					var _v5 = _p5._0._0;
					meaning = _v5;
					continue collapseDegenerates;
				} else {
					return _user$project$Bidding$And(
						A2(_elm_lang$core$List$map, _user$project$View$collapseDegenerates, _p5._0));
				}
			case 'Or':
				if ((_p5._0.ctor === '::') && (_p5._0._1.ctor === '[]')) {
					var _v6 = _p5._0._0;
			...
			case 'Deny':
				return _user$project$Bidding$Deny(
					_user$project$View$collapseDegenerates(_p5._0));
			default:
				return meaning;
		}
	}
};
var _user$project$View$hideDenials = function (meaning) {
	var scrub = function (child) {
		var _p6 = child;
		switch (_p6.ctor) {
			case 'And':
				return _elm_lang$core$Maybe$Just(
					_user$project$Bidding$And(
						A2(_elm_lang$core$List$map, _user$project$View$hideDenials, _p6._0)));
			case 'Or':
				return _elm_lang$core$Maybe$Just(
					_user$project$Bidding$Or(
						A2(_elm_lang$core$List$map, _user$project$View$hideDenials, _p6._0)));
			case 'Deny':
				return _elm_lang$core$Maybe$Nothing;
			default:
				return _elm_lang$core$Maybe$Just(child);
		}
	};
	var _p7 = meaning;
	switch (_p7.ctor) {
		case 'And':
			return _user$project$Bidding$And(
				A2(_elm_lang$core$List$filterMap, scrub, _p7._0));
		case 'Or':
			return _user$project$Bidding$Or(
				A2(_elm_lang$core$List$map, _user$project$View$hideDenials, _p7._0));
		default:
			return meaning;
	}
};
var _user$project$View$simplify = function (_p8) {
	return _user$project$View$collapseRedundancies(
		_user$project$View$collapseDegenerates(
			_user$project$View$hideDenials(_p8)));
};
var _user$project$View$viewConvention = function (convention) {
		...
		function () {
			...
			switch (_p9.ctor) {
				case 'Gerber':
					return 'Gerber';
				case 'JacobyTransfer':
					return 'Jacoby Transfer';
				default:
					return 'Stayman';
			}
		}());
};
var _user$project$View$viewDescription = function (bid) {
	return A2(
		...
		function () {
			...
			if (_p10._0.ctor === 'Just') {
				if (_p10._1.ctor === 'Just') {
					return _elm_lang$core$Native_List.fromArray(
						[
							_user$project$View$viewConvention(_p10._0._0),
							_elm_lang$html$Html$text(': '),
							_elm_lang$html$Html$text(_p10._1._0)
						]);
				} else {
					return _elm_lang$core$Native_List.fromArray(
						[
...
var _user$project$View$viewVulnerability = function (vuln) {
...
var _user$project$View$cluster = F3(
	function (filler, count, elems) {
		var pad = function (chunk) {
			return A2(
				...
				A2(
					_elm_lang$core$List$repeat,
					count - _elm_lang$core$List$length(chunk),
					filler));
		};
		var _p12 = A2(_elm_lang$core$List$take, count, elems);
		if (_p12.ctor === '[]') {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		} else {
			return A2(
				...
				pad(_p12),
				A3(
					_user$project$View$cluster,
					filler,
					count,
					A2(_elm_lang$core$List$drop, count, elems)));
		}
	});
var _user$project$View$suitText = function (suit) {
	var _p13 = suit;
	switch (_p13.ctor) {
		case 'Clubs':
			return '♣';
...
var _user$project$View$suitClass = function (suit) {
	var $class = function () {
		var _p14 = suit;
		switch (_p14.ctor) {
			case 'Clubs':
	...
	return _elm_lang$html$Html_Attributes$class($class);
};
var _user$project$View$viewBid = function (bid) {
	var viewTrump = function (trump) {
		...
		if (_p15.ctor === 'Just') {
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$suitClass(_p16)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_user$project$View$suitText(_p16))
					]));
		} else {
			return _elm_lang$html$Html$text('NT');
		}
	};
	var _p17 = bid;
	switch (_p17.ctor) {
		...
		case 'Redouble':
			return _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Redouble')
				]);
		default:
			return _elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$View$suitSymbol = function (suit) {
	return A2(
		_elm_lang$html$Html$span,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$suitClass(suit)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(
				_user$project$View$suitText(suit))
			]));
};
var _user$project$View$viewMetric = function (metric) {
	var _p18 = metric;
	switch (_p18.ctor) {
		case 'Constant':
			return _elm_lang$html$Html$text(
		...
		case 'HighCardPoints':
			return _elm_lang$html$Html$text('HCP');
		case 'Points':
			if (_p18._0.ctor === 'Nothing') {
				return _elm_lang$html$Html$text('Points (counting length)');
			} else {
				if (_p18._0._0.ctor === 'Nothing') {
					return _elm_lang$html$Html$text('Points (NT)');
				} else {
					return A2(
						_elm_lang$html$Html$span,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$View$suitSymbol(_p18._0._0._0),
								_elm_lang$html$Html$text(')')
							]));
				}
			}
		...
		default:
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Quick Losers ('),
						_user$project$View$suitSymbol(_p18._0),
						_elm_lang$html$Html$text(')')
					]));
	}
};
var _user$project$View$viewMeaning = function (meaning) {
	var list = F2(
		function (description, meanings) {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
						...
						A2(
							...
							function (m) {
								return A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_user$project$View$viewMeaning(m)
										]));
							},
							meanings))
					]));
	...
	switch (_p19.ctor) {
		...
		case 'InRange':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$viewMetric(_p19._0),
						_elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							' between ',
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									' and ',
									_elm_lang$core$Basics$toString(_p19._2)))))
					]));
		case 'Equal':
			return A2(
				_elm_lang$html$Html$span,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$viewMetric(_p19._0),
						_elm_lang$html$Html$text(' = '),
						_user$project$View$viewMetric(_p19._1)
					]));
		case 'Minimum':
			return A2(
				_elm_lang$html$Html$span,
		...
		case 'Balanced':
			return _elm_lang$html$Html$text('Balanced (4-3-3-3, 4-4-3-2, or 5-3-3-2)');
		case 'SemiBalanced':
			return _elm_lang$html$Html$text('Semi-balaned (5-4-2-2 or 6-3-2-2)');
		case 'Or':
			return A2(list, 'Any of:', _p19._0);
		case 'And':
			return A2(list, 'All of:', _p19._0);
		default:
			return A2(
				list,
				'Deny:',
...
var _user$project$View$viewExplanation = function (target) {
		...
		if (_p20.ctor === 'Nothing') {
			...
			return _elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$View$viewDescription(_p21),
					_user$project$View$viewMeaning(
					_user$project$View$simplify(_p21.meaning))
				]);
		}
	}();
	return A2(
...
var _user$project$View$makeBidCell = F3(
	function (system, favorability, history) {
		var levels = F2(
			function (bid1, bid2) {
				return _elm_lang$core$Native_Utils.eq(
					_user$project$Auction$level(bid1.bid),
					_user$project$Auction$level(bid2.bid));
			});
		var movePassToRightSide = function (bids) {
			...
			if ((_p22.ctor === '::') && (_p22._1.ctor === '::')) {
				var _p23 = _p22._1._0;
				return _elm_lang$core$Native_Utils.eq(
					_user$project$Auction$level(_p23.bid),
					0) ? A2(
					_elm_lang$core$List_ops['::'],
					_p23,
					A2(_elm_lang$core$List_ops['::'], _p22._0, _p22._1._1)) : bids;
			} else {
				return bids;
			}
		};
		var button = function (bid) {
			var events = _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					_user$project$Game$BidFromHuman(bid.bid)),
					_elm_lang$html$Html_Events$onMouseEnter(
					_user$project$Game$Explain(
						_elm_lang$core$Maybe$Just(bid))),
					_elm_lang$html$Html_Events$onMouseLeave(
					_user$project$Game$Explain(_elm_lang$core$Maybe$Nothing))
				]);
			return A2(
				_elm_lang$html$Html$button,
				events,
				_user$project$View$viewBid(bid.bid));
		};
		var legalBids = _user$project$Auction$legalBids(
			A2(
				_elm_lang$core$List$map,
				function (_) {
					return _.bid;
				...
				history));
		var annotatedLegalBids = A2(
			_elm_lang$core$List$map,
			A3(_user$project$Bidding$annotate, system, favorability, history),
			legalBids);
		var buttons = A2(
			_elm_community$elm_list_extra$List_Extra$intercalate,
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
			...
			A2(
				_elm_lang$core$List$map,
				_elm_lang$core$List$map(button),
				A2(
					_elm_community$elm_list_extra$List_Extra$groupBy,
					levels,
					movePassToRightSide(annotatedLegalBids))));
		return A2(
...
var _user$project$View$viewAuction = F4(
	function (dealer, system, vulnerability, annotatedAuction) {
		...
		var favorability = A2(
			_user$project$Vulnerability$favorability,
			A2(_user$project$Game$currentBidder, dealer, annotatedAuction),
			vulnerability);
		var auction = A2(
			_elm_lang$core$List$map,
			function (_) {
			...
			annotatedAuction);
		var makeBidCells = _user$project$Auction$isOpen(auction) ? _elm_lang$core$Native_List.fromArray(
			[
				A3(_user$project$View$makeBidCell, system, favorability, annotatedAuction)
			]) : _elm_lang$core$Native_List.fromArray(
			[]);
		var allCells = A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				...
				_elm_lang$core$List$reverse(
					A2(_elm_lang$core$List$map, bidCell, annotatedAuction)),
				makeBidCells));
		return A2(
			_elm_lang$html$Html$table,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('auction')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					A2(
						_elm_lang$core$List$map,
						row,
						A3(_user$project$View$cluster, blankCell, 4, allCells)))
				]));
	});
var _user$project$View$viewRank = function (card) {
	var value = function () {
		var _p25 = card.rank;
		switch (_p25.ctor) {
			case 'Ace':
...
var _user$project$View$viewSuit = F2(
	function (hand, suit) {
		var cards = A2(
			_elm_lang$core$List$sortWith,
			_user$project$Card$rankDescending,
			A2(
				...
				hand));
		var contents = _elm_lang$core$List$isEmpty(cards) ? _elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$li,
				_elm_lang$core$Native_List.fromArray(
			...
			]) : A2(_elm_lang$core$List$map, _user$project$View$viewRank, cards);
		return A2(
			_elm_lang$html$Html$li,
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$View$viewHand = F2(
	function (seat, hand) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(seat)),
					A2(
					_elm_lang$html$Html$ul,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('suits')
						]),
					A2(
						_elm_lang$core$List$map,
						_user$project$View$viewSuit(hand),
						_elm_lang$core$Native_List.fromArray(
							[_user$project$Card$Spades, _user$project$Card$Hearts, _user$project$Card$Diamonds, _user$project$Card$Clubs])))
				]));
	});
var _user$project$View$viewState = function (state) {
	var seatCell = function (seat) {
		return A2(
			_elm_lang$html$Html$td,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_user$project$View$viewHand,
					seat,
					A2(_user$project$Seat$lookup, seat, state.hands))
				]));
	};
	var emptyCell = A2(
		_elm_lang$html$Html$td,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$viewVulnerability(state.vulnerability),
				A2(
				_elm_lang$html$Html$table,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								emptyCell,
								seatCell(_user$project$Seat$North),
								emptyCell
							])),
						A2(
						_elm_lang$html$Html$tr,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								seatCell(_user$project$Seat$West),
								emptyCell,
								seatCell(_user$project$Seat$East)
							])),
						A2(
						_elm_lang$html$Html$tr,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								emptyCell,
								seatCell(_user$project$Seat$South),
								emptyCell
							]))
					])),
				A4(_user$project$View$viewAuction, state.dealer, state.system, state.vulnerability, state.auction),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Game$RageQuit)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Rage Quit')
					])),
				_user$project$View$viewExplanation(state.explained)
			]));
};
var _user$project$View$view = function (model) {
	var _p26 = model;
	if (_p26.ctor === 'Just') {
		return _user$project$View$viewState(_p26._0);
	} else {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
